...
const projects = [
    {
        ...
        description: 'I created a full customer support chatbot from scracht using modern technologies and my knoweledge',
        image: project1
    },
    {
        id: 2,
            ...
            <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12">
                <div>
                    ...
                    {projects.map((project) => (
                        ...
                        ${selectedProject.id === project.id ? 'text-purple-200' : ''} duration-300`}>{project.title}
                            </h3>
